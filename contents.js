...
window.YAW_CONTENTS = {
  ...
  parts: [
    ...
    },
    {
      ...
      items: [
        { n: '2.1', label: 'Send',      href: 'SIQPII/send.html',     status: 'live' },
        { n: '2.2', label: 'Search',    href: 'SIQPII/search.html',   status: 'live' },
        { n: '2.3', label: 'Sample',    href: 'SIQPII/sample.html',   status: 'live' },
